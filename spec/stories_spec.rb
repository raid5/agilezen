  ...
  describe "#story" do
    context "success" do
      it "performs an API request for a single story of a given project" do
        register_get('https://agilezen.com/api/v1/projects/123/stories/321', 'story.json')
      ...
      it "includes enrichments" do
        register_get('https://agilezen.com/api/v1/projects/15404/stories/2?with=details%2Ctags%2Cmetrics', 'story/2-with-enrichments.json')
      ...
      it "allows filtering" do
        register_get('https://agilezen.com/api/v1/projects/15404/stories/2?where=tag%3Aauthentication&with=tags', 'story/2-with-filtering.json')
    ...
    context "failure" do
      it "returns nil to indicate failure" do
        register_get('https://agilezen.com/api/v1/projects/99999/stories/11111', 'garbage.txt')
